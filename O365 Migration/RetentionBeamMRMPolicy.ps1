...
$LogFile = ".\$((Get-Date -uformat %Y-%m-%d_%H.%M.%S).ToString())_MRMPolicy_LogFile.txt"
...
Get-Mailbox -Identity $user -ResultSize unlimited | Set-Mailbox -RetentionPolicy "Contoso MRM Policy" >> $logfile
