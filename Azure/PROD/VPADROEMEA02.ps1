...
$VMName = "VPADROEMEA02ARM"
$OSDiskUri = "https://sanedvtitprodvhdos01arm.blob.core.windows.net/vhds/VPADROEMEA02.vhd"
$DataDiskUri = "https://sanedvtitprodvhdata01arm.blob.core.windows.net/vhds/VPADROEMEA02-DATA01.vhd"
