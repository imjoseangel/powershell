...
$VMName = "VPINTER01ARM"
$OSDiskUri = "https://sanedvtitprodvhdos01arm.blob.core.windows.net/vhds/VPINTER01.vhd"
$DataDiskUri = "https://sanedvtitprodvhdata01arm.blob.core.windows.net/vhds/VPINTER01-DATA01.vhd"
$Data2DiskUri = "https://sanedvtitprodvhdata01arm.blob.core.windows.net/vhds/VPINTER01-DATA02.vhd"
$VMSize = "Standard_D1"
